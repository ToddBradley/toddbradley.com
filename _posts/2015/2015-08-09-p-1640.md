...
[Beth](https://bethpartin.com/) and I both like to travel. A few years ago, we started to wonder if we could just do it full time. About the same time, the notion of the “[location independent](https://en.wikipedia.org/wiki/Location_independence) lifestyle” first hit the edge of the mainstream. We learned there were others like us — people who weren’t at traditional retirement age, but who wanted to spend less time at a traditional job and more time seeing the world.
...
By the way, I just wrote all this using [OmmWriter](https://www.ommwriter.com/en/) and highly recommend it. It helps me focus on writing by blocking out all the other distractions on my laptop.
