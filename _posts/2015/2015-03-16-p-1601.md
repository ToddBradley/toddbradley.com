...
In case you didn’t already know this about me, I administer a web forum called [SCDSsupport.org](http://scdssupport.org/), which is the world’s largest online group for sufferers of [SCDS](https://en.wikipedia.org/wiki/Superior_canal_dehiscence). Because of this, I get a lot of emails from people about the disease — some who have it, some who want to join the (private) forum to talk about it with others, and so on.
