...
Next thing I tried was running the name “Everson” through Google Desktop. If you don’t have it, you should get it. [Google Desktop](https://desktop.google.com/) monitors and indexes all the files and emails on your PC and then allows you to quickly search for text strings. So, if I’ve ever received an email from an Everson, Google Desktop would know about it. But a search brought up absolutely nothing.
